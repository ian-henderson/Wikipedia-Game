...
def get_algorithm():
    ...
    while algorithm not in range(1, 4):
        if algorithm:
            print('%s wasn\'t an option. Try again.' % algorithm)
        print('\nEnter selection for an algorithm.')
...
def breadth_first_search(root_page, target_page):
    G = {}
    G[root_page.title] = {
...
def wikipedia_game():
    ...
    if algorithm == 1:
        breadth_first_search(root_page, target_page)
    # else if algorithm == 2:
        # depth_first_search(root_page, target_page)
    # else if algorithm == 3:
        # iterative_deepining_depth_first_search(root_page, target_page)
